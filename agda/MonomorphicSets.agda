...
wrec : (A : Set) → (B : A → Set) → (C : W A B → Set)
     ...
     → (c : W A B) → C c
wrec A B C d (sup a b) = d a b (λ x → wrec A B C d (b x))
...
U-elim : (C : U → Set)
         ...
         → (C n₁)
         → ((a b : U) → C a → C b → C (a ⊕ b))
         → ((a : U) → (b : T a → U) → C a → ((x : T a) → C (b x)) → C (σ a b))
         → ((a : U) → (b : T a → U) → C a → ((x : T a) → C (b x)) → C (π a b))
         → (C n)
         → ((a : U) → (b : T a → U) → C a → ((x : T a) → C (b x)) → C (w a b))
         → ((a : U) → (b c : T a) → C a → C (i a b c))
         → (x : U)
         → C x

U-elim C d₀ d₁ d_⊕ d_σ d_π d_n d_w d_i n₀ = d₀
U-elim C d₀ d₁ d_⊕ d_σ d_π d_n d_w d_i n₁ = d₁
U-elim C d₀ d₁ d_⊕ d_σ d_π d_n d_w d_i (a ⊕ b) = d_⊕ a b
                                                 (U-elim C d₀ d₁ d_⊕ d_σ d_π d_n d_w d_i a)
                                                 (U-elim C d₀ d₁ d_⊕ d_σ d_π d_n d_w d_i b)
U-elim C d₀ d₁ d_⊕ d_σ d_π d_n d_w d_i (σ a b) = d_σ a b
                                                 (U-elim C d₀ d₁ d_⊕ d_σ d_π d_n d_w d_i a)
                                                          λ x → U-elim C d₀ d₁ d_⊕ d_σ d_π d_n d_w d_i (b x)
U-elim C d₀ d₁ d_⊕ d_σ d_π d_n d_w d_i (π a b) = d_π a b
                                                 (U-elim C d₀ d₁ d_⊕ d_σ d_π d_n d_w d_i a)
                                                         λ x → U-elim C d₀ d₁ d_⊕ d_σ d_π d_n d_w d_i (b x)
U-elim C d₀ d₁ d_⊕ d_σ d_π d_n d_w d_i n = d_n
U-elim C d₀ d₁ d_⊕ d_σ d_π d_n d_w d_i (w a b) = d_w a b
                                                 (U-elim C d₀ d₁ d_⊕ d_σ d_π d_n d_w d_i a)
                                                         λ x → U-elim C d₀ d₁ d_⊕ d_σ d_π d_n d_w d_i (b x)
U-elim C d₀ d₁ d_⊕ d_σ d_π d_n d_w d_i (i a b c) = d_i a b c (U-elim C d₀ d₁ d_⊕ d_σ d_π d_n d_w d_i a)
